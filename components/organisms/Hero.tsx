    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
      <div className="max-w-4xl space-y-6 md:space-y-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-5">
          <Button size="lg" className="gap-3 w-full sm:w-auto bg-[#25D366] hover:bg-[#128C7E] text-white border-none shadow-2xl shadow-green-500/20 py-4 md:py-5">
            <MessageCircle className="w-5 h-5 fill-current" /> Consultar por WhatsApp
          </Button>
          <Button variant="glass" size="lg" className="w-full sm:w-auto py-4 md:py-5">
            Ver Equipos
          </Button>
        </div>
