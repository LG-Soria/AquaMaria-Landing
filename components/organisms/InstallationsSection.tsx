...
const installations = [
  { src: '/images/instalaciones/3.png', caption: 'Oficina', className: 'md:col-span-2 md:row-span-2', position: 'object-[68%_center]' },
  { src: '/images/instalaciones/1.png', caption: 'Espacio de trabajo', className: '', position: 'object-center' },
  { src: '/images/instalaciones/2.png', caption: 'Comercio', className: '', position: 'object-center' },
  { src: '/images/instalaciones/4.png', caption: 'Área común', className: 'md:col-span-2', position: 'object-[50%_75%]' }
];  
  ...
  <section className="py-16 md:py-24 bg-white border-t border-slate-100">
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20">
        ...
        <h2 className="text-4xl font-extrabold text-slate-900 mt-6 tracking-tight">Instalaciones reales de AquaMaría</h2>
